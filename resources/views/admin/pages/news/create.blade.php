<x-admin-app-layout :title="'News Add'">
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <form id="kt_ecommerce_add_news_form" method="post" action="{{ route('admin.news.store') }}"
                                    ...
                                    <div class="pt-0 card-body">
                                        <div class="mb-5 fv-row">
                                            ...
                                            <x-metronic.input type="text" name="title" class="mb-2 form-control"
                                                placeholder="News English Title" :value="old('title')">
                                            </x-metronic.input>
                                        ...
                                        <div class="mb-5 fv-row">
                                            ...
                                            <x-metronic.textarea id="bangla_summary" name="bangla_summary"
                                                ...
                                                rows="3">{!! old('bangla_summary') !!}</x-metronic.textarea>
                                        </div>
                                    ...
                                    <div class="pt-0 card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                {{-- <div class="form-check form-check-custom form-check-solid mb-7">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="show_on_homepage" id="show_on_homepage" value="1"
