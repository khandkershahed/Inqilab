    ...
    <div class="card card-flash">
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{ route('admin.epaper.create') }}" class="btn btn-light-primary">
                ...
                <tbody class="fw-bold text-gray-600">
                    ...
                    @foreach ($epapers as $key => $epaper)
                        ...
                        <tr>
                            ...
                            <td>
                                {{-- @if (Auth::guard('admin')->user()->can('edit.epaper')) --}}
                                <a href="{{ route('admin.epaper.edit', $epaper->id) }}" class="text-primary">
                                    <i class="fa-solid fa-edit text-primary me-7 fs-4"></i>
                                </a>
                                {{-- @endif

                                @if (Auth::guard('admin')->user()->can('delete.epaper')) --}}
                                <a href="{{ route('admin.epaper.destroy', $epaper->id) }}" class="delete">
