<x-admin-app-layout :title="'Return and Policy'">
    ...
    <div class="card card-flash">
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{ route('admin.return-policy.create') }}" class="btn btn-light-primary">
                    ...
                    @foreach ($items as $key => $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.return-policy.destroy', $item->id) }}" class="delete">
