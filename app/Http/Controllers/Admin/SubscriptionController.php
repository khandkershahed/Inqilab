...
class SubscriptionController extends Controller
{
    ...
    {
        return view('admin.pages.subscribedEmail.index',['emails' => Subscription::get()]);
    }
     ...
     */
    public function show(Subscription $newsletter)
    {
        //
    }
     ...
     */
    public function edit(Subscription $newsletter)
    {
        //
    }
     ...
     */
    public function update(Request $request, Subscription $newsletter)
    {
        $newsletter->update([
            'email'              => $request->email,
            'ip_address'         => $request->ip(),
     ...
     */
    public function destroy(Subscription $newsletter)
    {
        $newsletter->delete();
    }
}
